    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Jenishe</span> Salem
                <br />BSCS
                <span class="poppins text-violet-400">Student</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                I am currently a <span class="text-violet-400"> 3rd Year College Student</span>, and I aim to be a Developer someday
            </p>
            <button
        ...
        <div class="relative shadow-2xl grid place-items-center">
            <img
                src={"https://scontent.fmnl4-3.fna.fbcdn.net/v/t39.30808-6/380481578_7285603838131038_1922518625440514719_n.jpg?stp=cp6_dst-jpg&_nc_cat=110&ccb=1-7&_nc_sid=a5f93a&_nc_eui2=AeFAiNDlDdEiC_YDK0srg6ozfJZ1eagntz98lnV5qCe3P4CZEPJir769S_DpFP6ObHC5ksK1sZjvmvpQl49jf2_8&_nc_ohc=fhfIXZ6GxacQ7kNvgHP0H-W&_nc_zt=23&_nc_ht=scontent.fmnl4-3.fna&_nc_gid=AdXb0QP-Qp7J5Dv16NA-sCF&oh=00_AYAYLFBbnU8acNTsil88qvv-qkG4JB6kH_roFPxZ80lrwQ&oe=670DB8A3"}
                alt="Zetane Engine"
